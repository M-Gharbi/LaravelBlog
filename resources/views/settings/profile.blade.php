                  ...
                  <div class="row">
                    <div class="col-md-8">
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" name="company" value="" id="post" class="form-control">
                      </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                <div class="fileinput-new img-thumbnail" style="width: 150px; height: 150px;">
                                  <img src="{{ $user->profile_picture ? asset('upload/' . $user->profile_picture) : 'http://via.placeholder.com/150x150' }}"  alt="..." width="140" height="140">
                                </div>
